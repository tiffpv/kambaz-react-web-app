    ...
    return(
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                <h4>Paragraph Tag</h4>
                <p id="wd-p-1">
                    This is a paragraph. We often separate a long
                    set of sentences with vertical spaces to make
                    the text easier to read. Browsers ignore
                    vertifical white spaces and render all the text as
                    one single set of sentences. To force the
                    browser to add vertical spacing, wrap the
                    paragraphs you want to separate with the 
                    paragraph tag
                </p>
                <p id="wd-p-2">
                    This is the first paragraph. The paragraph tag is used to format
                    vertifical gaps between long pieces of text like this one.
                </p>
                <p id="wd-p-3">
                    This is the second paragraph. Even though there is deliberate white
            ...
            <div id="wd-lists">
                ...
                My favorite recipe: Rao's Pasta
                <ol id="wd-your-favorite-recipe">
                    <li>Boil a pot of water on medium heat.</li>
                    <li>Add pasta to pot when water is boiling.</li>
                    <li>Boil pasta for 8-12 minutes.</li>
                    <li>Heat Rao's pasta sauce in another pan.</li>
                    <li>Add cooked pasta to heated sauce.</li>
                    <li>Mix pasta in sauce for 2-3 minutes.</li>
                    <li>Serve and enjoy!</li>
                </ol>
                ...
                Tiffany's favorite books (in no particular order)
                <ul id="wd-your-books">
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <h5>Select many</h5>
                    <label htmlFor="wd-select-may-genre"> Favorite movie genres: </label><br/>
